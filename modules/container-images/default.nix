...

{
  options.myContainerImages = lib.mkOption {
    ...
    default = {
      ...
      dozzle = "docker.io/amir20/dozzle:v10.6.9";
      ...
      homebridge = "docker.io/homebridge/homebridge:2026-07-12";
      immich-machine-learning = "ghcr.io/immich-app/immich-machine-learning:v3.0.2-cuda";
      ...
      immich-server = "ghcr.io/immich-app/immich-server:v3.0.2";
      ...
      litellm = "docker.litellm.ai/berriai/litellm:v1.92.0@sha256:9ef6f45bc0104940571765e610c52a1d761b5ec85efcd193795281086ee61277";
      mealie = "ghcr.io/mealie-recipes/mealie:v3.20.1";
      miniflux = "miniflux/miniflux:2.3.2";
      ntfy = "binwiederhier/ntfy:v2.26.0";
      ...
      searxng = "docker.io/searxng/searxng:2026.7.13-9e25585ae";
