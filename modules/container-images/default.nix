...

{
  options.myContainerImages = lib.mkOption {
    ...
    default = {
      ...
      karakeep-meilisearch = "getmeili/meilisearch:v1.53.1";
      litellm = "docker.litellm.ai/berriai/litellm:v1.96.2@sha256:154e23bb5f31b1f10e16392a8ef299bd2cde08de3a64a6849002cfcc25ce3c63";
      mealie = "ghcr.io/mealie-recipes/mealie:v3.22.0";
      miniflux = "miniflux/miniflux:2.3.3";
      ntfy = "binwiederhier/ntfy:v2.27.0";
      ollama = "ollama/ollama:0.32.11";
      ...
      piper = "lscr.io/linuxserver/piper:2.4.2";
      ...
      searxng = "docker.io/searxng/searxng:2026.8.14-094c33d40";
