...

{
  options.myContainerImages = lib.mkOption {
    ...
    default = {
      ...
      dozzle = "docker.io/amir20/dozzle:v10.6.6";
      freshrss = "freshrss/freshrss:1.29.1";
      homeassistant = "linuxserver/homeassistant:version-2026.6.4";
      ...
      karakeep-meilisearch = "getmeili/meilisearch:v1.48.2";
      komga = "gotson/komga:1.24.4";
      ...
      searxng = "docker.io/searxng/searxng:2026.6.28-8605230eb";
      ...
      whisper = "lscr.io/linuxserver/faster-whisper:3.3.0-gpu";
    };
