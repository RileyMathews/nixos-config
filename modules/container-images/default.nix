...

{
  options.myContainerImages = lib.mkOption {
    ...
    default = {
      ...
      bookshelf = "ghcr.io/rileymathews/papyrd-server:alpha-2";
      ...
      homeassistant = "linuxserver/homeassistant:version-2026.4.4";
      ...
      karakeep = "ghcr.io/karakeep-app/karakeep:0.31.0";
      karakeep-chrome = "gcr.io/zenika-hub/alpine-chrome:124";
      karakeep-meilisearch = "getmeili/meilisearch:v1.13.3";
      komga = "gotson/komga";
      mealie = "ghcr.io/mealie-recipes/mealie:v3.16.0";
      miniflux = "miniflux/miniflux:2.2.17";
      ntfy = "binwiederhier/ntfy:v2.22.0";
      ollama = "ollama/ollama:0.21.3";
      open-webui = "ghcr.io/open-webui/open-webui:0.9.2";
      paperless = "ghcr.io/paperless-ngx/paperless-ngx:2.20.14";
      ...
      vaultwarden = "vaultwarden/server:1.35.7";
