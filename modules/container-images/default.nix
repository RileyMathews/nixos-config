...

{
  options.myContainerImages = lib.mkOption {
    ...
    default = {
      audiobookshelf = "ghcr.io/advplyr/audiobookshelf:2.36.0";
      bookshelf = "ghcr.io/rileymathews/papyrd-server:alpha-11";
      buffer = "registry.rileymathews.com/rileymathews/buffer:0.0.27-alpha";
      copyparty = "copyparty/ac:1.20.20";
      docker-registry = "registry:3.1.1";
      dozzle = "docker.io/amir20/dozzle:v10.7.1";
      freshrss = "freshrss/freshrss:1.29.1";
      homeassistant = "linuxserver/homeassistant:version-2026.8.1";
      homebox = "ghcr.io/sysadminsmedia/homebox:0.26.2";
      homebridge = "docker.io/homebridge/homebridge:2026-08-08";
      immich-machine-learning = "ghcr.io/immich-app/immich-machine-learning:v3.1.0-cuda";
      ...
      karakeep = "ghcr.io/karakeep-app/karakeep:0.33.1";
      karakeep-chrome = "gcr.io/zenika-hub/alpine-chrome:124";
      karakeep-meilisearch = "getmeili/meilisearch:v1.53.0";
      litellm = "docker.litellm.ai/berriai/litellm:v1.95.1@sha256:a67d759776704f6e270b43f04e219ac7f758c9a9e6cf06bf7133d81694b37360";
      mealie = "ghcr.io/mealie-recipes/mealie:v3.22.0";
      miniflux = "miniflux/miniflux:2.3.3";
      ntfy = "binwiederhier/ntfy:v2.27.0";
      ollama = "ollama/ollama:0.32.6";
      open-webui = "ghcr.io/open-webui/open-webui:0.11.0";
      paperless = "ghcr.io/paperless-ngx/paperless-ngx:3.0.5";
      ...
      searxng = "docker.io/searxng/searxng:2026.8.10-0a118066d";
