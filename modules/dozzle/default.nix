...

{
  ...
  virtualisation.oci-containers.containers.dozzle = {
    ...
    environment = {
      ...
      DOZZLE_REMOTE_AGENT = "enterprise:7007|enterprise|Homelab,yamato:7007|yamato|Homelab,data:7007|data|Homelab,defiant:7007|defiant|Homelab,bridge:7007|bridge|Homelab,worf:7007|worf|Homelab,immichdb:7007|immichdb|Homelab,lab:7007|lab|Homelab";
    };
  };
